...
def athlete_checkbox_keyboard(
    ...
    buttons.append([InlineKeyboardButton(text=t("cancel", lang), callback_data="entry_cancel")])
    return InlineKeyboardMarkup(inline_keyboard=buttons)


def age_category_keyboard(categories: list[str], lang: str) -> InlineKeyboardMarkup:
    buttons = []
    for cat in categories:
        buttons.append([InlineKeyboardButton(text=cat, callback_data=f"entry_age:{cat}")])
    buttons.append([InlineKeyboardButton(text=t("cancel", lang), callback_data="entry_cancel")])
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def confirm_entries_keyboard(lang: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=t("confirm", lang), callback_data="confirm_entries"),
...
def my_entries_keyboard(entries: list[tuple[UUID, str, str]], lang: str) -> InlineKeyboardMarkup:
...
def entry_detail_keyboard(
    ...
    *,
    ...
    buttons.append([InlineKeyboardButton(text=t("back", lang), callback_data="back_my_entries")])
    return InlineKeyboardMarkup(inline_keyboard=buttons)
